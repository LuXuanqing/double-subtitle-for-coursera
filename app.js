var subtitle = {
    ...
    init: function () {
        ...
        div.style.cssText = "color: white; text-align: center; width: 100%; background-color: rgba(0, 0, 0, 0.5); position: absolute; font-size: 20px; padding: 3px; bottom: 0px; left: 50%; transform: translateX(-50%);"
